...
class TicTacToe:
    def __init__(self):
        self.board = [' ' for _ in range(9)] # we will use a single list to rep 3*3
        self.current_winner = None # keep a track of winner!
    ...
    def winner(self, square, letter):
        ...
        # these are the only moves possible to win  diagnol
        if square % 2 == 0:
